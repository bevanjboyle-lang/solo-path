 ...
 *
 * USAGE: passed to OpenAI `response_format: { type: "json_schema", json_schema: REPORT_SCHEMA }`
 ...
 * Related: prompts/prompt-1-core-report.md (narrative rubric)
 *
...
export const REPORT_SCHEMA = {
  ...
  schema: {
    ...
    properties: {
      ...
      // ================================================================
      // 4. Options (8–10, enforced in validator)
      // ================================================================
      options: {
        type: "array",
        items: {
