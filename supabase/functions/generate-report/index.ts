...
serve(async (req) => {
  ...
  try {
    ...
    // Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ PROMPT 1: Core Report Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
5. Return JSON with this exact structure. IMPORTANT: model_name MUST be the human-readable "name" field from BUSINESS_MODELS (e.g. "Process Improvement Consultant"), NEVER the "id" field (e.g. "BM_PROCIM").
{
  ...
  "first_steps": [string, string, string, string, string]
    ...
    // Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ PROMPT 2: Evaluation Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    const p2System = `You are a senior commercial critic. Evaluate the Solo report against 6 criteria:
1. Specificity Ã¢ÂÂ target_buyer must name type/size/situation
2. Commercial realism Ã¢ÂÂ pricing and timelines plausible for UK market
3. Option diversity Ã¢ÂÂ 3 options must not share same category or sales motion
4. Recommendation quality Ã¢ÂÂ specific reason tied to this user
5. Reality check honesty Ã¢ÂÂ archetype-specific failure modes, GBP figures in income outlook
6. First steps quality Ã¢ÂÂ all 5 specific and tied to recommended model

Additionally, generate a "hook_insight" Ã¢ÂÂ a single punchy sentence of 8Ã¢ÂÂ12 words that captures the most commercially compelling insight about this user's independent potential. Use their industry experience (Q6), reputation (Q7), client/sector knowledge (Q11), and any independent work history (Q12) to craft this. It should read like a headline that would make the user want to see their full report.
...
Hard constraint: NEVER change a model_name value.`;
    ...
    // Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ PROMPTS 3 & 4 in parallel Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
Return JSON:
{
  ...
  "network_toolkit": {
    ...
    const p4System = `You are Solo's market research analyst. Produce a Local Market Feasibility Snapshot. You do not have live data Ã¢ÂÂ label all figures as indicative.
...
[Model name] | [Location]
Prepared as indicative research Ã¢ÂÂ not primary market data`;
...
Pricing: ÃÂ£${recommendedOption?.pricing?.range_low_gbp || "?"} Ã¢ÂÂ ÃÂ£${recommendedOption?.pricing?.range_high_gbp || "?"} ${recommendedOption?.pricing?.cadence || ""}
Location: ${answers["15"] || "UK"}`;

    // Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ PROMPT 7: AI Impact & Adaptation Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    ...
    const p7System = `You are Solo's AI impact analyst. Your job is to write a clear, specific, commercially honest assessment of how AI will affect this user's career Ã¢ÂÂ both their current role and their recommended Plan B path.

THE THREE PARTS YOU MUST WRITE:

Part 1 Ã¢ÂÂ AI Risk to Your Current Role: Write a candid, archetype-specific assessment. Name specific pressure mechanisms, identify resilient aspects, provide honest near-term outlook.

Part 2 Ã¢ÂÂ AI Resilience of Your Plan B: State displacement risk honestly, explain specifically how AI could enhance this model, describe how to position as AI-enabled.

Part 3 Ã¢ÂÂ Your Adaptation Path: Write 3-5 specific, actionable things tied to their specific recommended business model. Name real tools and platforms. Achievable in 90 days.
