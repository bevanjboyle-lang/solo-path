...
const sections: LegalSection[] = [
  ...
  { id: "subscription", title: "Subscription (£19/month or £149/year)", content: <p>Optional, available after initial 30-day plan. Includes ongoing tracker, full guidance library (32 modules), and Ask Solo. Cancel any time. Access continues to end of billing period.</p> },
