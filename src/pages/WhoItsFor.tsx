...
const archetypes = [
  { title: "Risk, Audit & Compliance", who: "Internal audit managers, Big Four risk/compliance professionals, regulatory specialists, financial crime leads", have: "Deep process knowledge, regulatory expertise, structured thinking, institutional credibility", insight: "Smaller firms, scale-ups, and PE-backed businesses constantly need exactly this expertise but can't justify a full-time hire", path: "Independent compliance consultant working with 2–3 SME or fintech clients on a retainer basis.", rate: "£500–£800", time: "4–8 weeks" },
  { title: "Finance & Commercial", who: "FP&A managers, finance business partners, commercial analysts, CFO-track professionals", have: "Financial modelling, commercial narrative, board-level communication, P&L ownership", insight: "Founders and scale-up businesses desperately need financial rigour but rarely have it. A fractional CFO or FD is one of the most in-demand solo models in the UK market.", path: "Fractional Finance Director serving 2–3 growth businesses.", rate: "£600–£900", time: "6–10 weeks" },
  { title: "Programme & Transformation", who: "PMO leads, change managers, programme directors, transformation consultants, delivery leads", have: "Structured delivery, stakeholder management, governance design, cross-functional experience", insight: "Every mid-size organisation undertaking a significant change project needs this skill set. Most don't want to hire it permanently.", path: "Independent transformation consultant or fractional Programme Director.", rate: "£550–£850", time: "4–8 weeks" },
  { title: "Operations & Process", who: "Operations managers, process improvement leads, business analysts, COO-track professionals", have: "Process design, operational efficiency, systems thinking, cross-functional coordination", insight: "Growing businesses consistently have the same operational problems. Pattern recognition across industries is genuinely valuable to a business owner who's never seen it before.", path: "Operational consultant or fractional COO working with SMEs or scale-ups on specific operational challenges.", rate: "£450–£750", time: "6–10 weeks" },
  { title: "Generalist Consultant / Interim", who: "Management consultants, strategy professionals, interim managers, advisory specialists", have: "Problem structuring, stakeholder management, analysis, delivery experience across sectors", insight: "The jump from employed consultant to independent consultant is shorter than it looks. The main blocker is rarely capability — it's the first introduction.", path: "Independent management consultant or advisory professional working with 1–2 clients at a time.", rate: "£600–£1,000", time: "4–8 weeks" },
];
      ...
      <PanelLayout className="mt-20 px-6 py-16 sm:px-10">
        <section className="flex min-h-[50vh] flex-col items-center justify-center">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <motion.p className="mx-auto mt-6 max-w-[560px] text-base leading-relaxed text-muted-foreground sm:text-lg" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.15 }}>
