  ...
  return (
    <section>
      ...
      <div className="rounded-lg bg-card border-l-[6px] border-primary p-6 sm:p-8">
        ...
        <p className="text-sm leading-relaxed text-secondary-foreground mb-6">{SAMPLE_PORTFOLIO_SUMMARY.strategy}</p>

        <h3 className="text-[1.3rem] font-bold text-foreground mb-3">How You'll Allocate Your Time</h3>
        <p className="text-sm leading-relaxed text-secondary-foreground mb-6">{SAMPLE_PORTFOLIO_SUMMARY.effort_distribution}</p>
